...
docker build -t 662315753219.dkr.ecr.us-east-2.amazonaws.com/soutendijk-billboard:latest --file web.dockerfile .

# Push the Docker image to AWS Container Registry
docker push 662315753219.dkr.ecr.us-east-2.amazonaws.com/soutendijk-billboard:latest
