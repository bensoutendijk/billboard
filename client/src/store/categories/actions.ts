...
import { CategoriesError, Category, CategoryForm } from "./types";
...
export const createCategoryFailed = createAction<CategoriesError>(
...
export const rejectCategories =
  createAction<CategoriesError>("REJECT_CATEGORIES");

export const postCategoryPending = createAction("POST_CATEGORY_PENDING");
export const postCategorySuccess = createAction<Category>(
  "POST_CATEGORY_SUCCESS"
);
export const postCategoryFailed = createAction<CategoriesError>(
  "POST_CATEGORY_FAILED"
);

export const removeCategoryPending = createAction("REMOVE_CATEGORY_PENDING");
export const removeCategorySuccess = createAction<Category>(
  "REMOVE_CATEGORY_SUCCESS"
);
export const removeCategoryFailed = createAction<CategoriesError>(
  "REMOVE_CATEGORY_FAILED"
);

export const updateCategoryForm = createAction<CategoryForm>(
  "UPDATE_CATEGORY_FORM"
);

export const createCategory =
  (formData: Omit<CategoryForm, "id">) =>
